...
const updateStatusContract = async (req, res) => {
    const contract = await emissionService.updateStatusContract(req.params.cvigencia, req.body);
...
const updateStatusPolicy = async (req, res) => {
    const policy = await emissionService.updateStatusPolicy(req.params.cpoliza, req.body);
